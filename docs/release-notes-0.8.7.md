...
OMB's instruction surfaces now have a cleaner shared contract across the root orchestrator, templates, generated guidance, and the prompt catalog.
...
Representative PRs:
- [#619](https://github.com/Yeachan-Heo/oh-my-codebuddy/pull/619) — XML-tag prompt migration
- [#620](https://github.com/Yeachan-Heo/oh-my-codebuddy/pull/620) — prompt-guidance contract documentation
- [#623](https://github.com/Yeachan-Heo/oh-my-codebuddy/pull/623) — 2-layer orchestrator / role-prompt documentation
- [#625](https://github.com/Yeachan-Heo/oh-my-codebuddy/pull/625) — leader-only orchestration boundaries
...
PR: [#624](https://github.com/Yeachan-Heo/oh-my-codebuddy/pull/624)

### MCP server stdio teardown unification

OMB's MCP stdio entrypoints now share one idempotent shutdown path instead of duplicating raw transport bootstrap logic in each server.
...
PRs: [#626](https://github.com/Yeachan-Heo/oh-my-codebuddy/pull/626), [#627](https://github.com/Yeachan-Heo/oh-my-codebuddy/pull/627)
...
- adds `src/cli/__tests__/package-bin-contract.test.ts` so the global-install `omb` entrypoint stays covered in CI

PR: [#633](https://github.com/Yeachan-Heo/oh-my-codebuddy/pull/633)

## Bug fixes and operational polish

### Windows / tmux capability handling

OMB no longer blocks native Windows purely because the platform is `win32`.
...
PR: [#616](https://github.com/Yeachan-Heo/oh-my-codebuddy/pull/616)
...
577c416 fix(mcp): centralize stdio lifecycle teardown for OMB servers (#626) (#627)
