...
| Version smoke | `node bin/omb.js version` | PASS (`oh-my-codebuddy v0.8.4`) |
...
- This is a focused patch release centered on `omb setup` refresh behavior and managed model upgrade prompting.
