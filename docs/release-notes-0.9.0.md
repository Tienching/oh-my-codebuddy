...
- introduces `omb sparkshell <command> [args...]` as an explicit operator-facing native sidecar
- allows qualifying read-only shell-native `omb explore` tasks to route through `omb sparkshell`
- keeps the explore path intentionally constrained: shell-only, read-only, and allowlisted

Representative changes:
- `fb07c3c` — feat: add omb explore harness and packaging flow
- `71858c3` — feat: add omb sparkshell and team inspection metadata
...
This release:
- exposes `omb sparkshell --tmux-pane <pane-id> --tail-lines <100-1000>` for explicit pane summarization
...
- Expect `omb explore` and `omb sparkshell` packaged installs to rely on release-asset hydration when no explicit binary override or repo-local artifact is present.
...
- [#782](https://github.com/Yeachan-Heo/oh-my-codebuddy/pull/782) — explore routes qualifying read-only shell tasks via sparkshell
...
- [#794](https://github.com/Yeachan-Heo/oh-my-codebuddy/pull/794) — merge `experimental/dev` into `dev`
- [#805](https://github.com/Yeachan-Heo/oh-my-codebuddy/pull/805) — keep workers running after mailbox replies

## Related issues highlighted in this release

- [#781](https://github.com/Yeachan-Heo/oh-my-codebuddy/pull/781) — force low reasoning for sparkshell summaries
- [#744](https://github.com/Yeachan-Heo/oh-my-codebuddy/issues/744) — persist lifecycle profiles for linked Ralph vs default team runs
- [#745](https://github.com/Yeachan-Heo/oh-my-codebuddy/issues/745) — team cleanup policy hardening
- [#746](https://github.com/Yeachan-Heo/oh-my-codebuddy/issues/746) — team policy/governance split follow-through
- [#741](https://github.com/Yeachan-Heo/oh-my-codebuddy/issues/741) — release-readiness / linked team-Ralph runtime follow-up
- [#732](https://github.com/Yeachan-Heo/oh-my-codebuddy/issues/732) — related team stall/lifecycle cleanup follow-up
