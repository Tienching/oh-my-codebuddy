...
- `refactor(mcp): extract omb_run_team_* to dedicated team-server.ts` (#431)
...
- Skills canonical OMB path normalization.
...
| `node bin/omb.js --help` | 0 | CLI usage rendered |
| `node bin/omb.js doctor` | 0 | `Results: 9 passed, 0 warnings, 0 failed` |
| `node bin/omb.js version` | 0 | `oh-my-codebuddy v0.7.6` |
| `node bin/omb.js status` | 0 | mode status rendered |
| `node bin/omb.js setup --dry-run` | 0 | dry-run setup completed |
| `node bin/omb.js cancel` | 0 | cancel command completed |
