# oh-my-codebuddy v0.9.1

<p align="center">
  <img src="https://raw.githubusercontent.com/Yeachan-Heo/oh-my-codebuddy/v0.9.1/docs/shared/omb-character-spark-initiative.jpg" alt="OMB character sparked for the Spark Initiative" width="720">
</p>
...
- The required packed-install smoke hydration fix landed later on `dev` in PR [#806](https://github.com/Yeachan-Heo/oh-my-codebuddy/pull/806).
