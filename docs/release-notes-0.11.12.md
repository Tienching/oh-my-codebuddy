...
`0.11.12` is a patch release after `0.11.11` that removes more Windows terminal flicker paths, closes additional team/runtime seam gaps, makes Node test execution cross-platform, and aligns workflow docs around the current OMB onboarding path.
...
- tmux readiness and auto-nudge behavior stay scoped to OMB-managed sessions
