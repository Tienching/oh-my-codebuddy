...
- qualifying read-only shell-native `omb explore` prompts can route through `omb sparkshell`
...
- [#781](https://github.com/Yeachan-Heo/oh-my-codebuddy/pull/781) — sparkshell summary reasoning hardening
- [#744](https://github.com/Yeachan-Heo/oh-my-codebuddy/issues/744) — lifecycle profile persistence
- [#745](https://github.com/Yeachan-Heo/oh-my-codebuddy/issues/745) — cleanup policy hardening
- [#746](https://github.com/Yeachan-Heo/oh-my-codebuddy/issues/746) — governance split follow-through
- [#741](https://github.com/Yeachan-Heo/oh-my-codebuddy/issues/741) — linked Ralph/team runtime follow-up
- [#732](https://github.com/Yeachan-Heo/oh-my-codebuddy/issues/732) — related team lifecycle follow-up
