...
OMB now ships an anti-slop workflow across its guidance/catalog surfaces.
...
PR: [#634](https://github.com/Yeachan-Heo/oh-my-codebuddy/pull/634)
...
PR: [#642](https://github.com/Yeachan-Heo/oh-my-codebuddy/pull/642)
...
PR: [#637](https://github.com/Yeachan-Heo/oh-my-codebuddy/pull/637)

### Packaging and routing contract fixes

This release also includes smaller contract corrections:
- normalizes the published npm bin path and updates package-bin regression coverage ([#638](https://github.com/Yeachan-Heo/oh-my-codebuddy/pull/638))
- explicitly reserves the worker role for team mode in prompt-guidance routing, with regression coverage via PR [#641](https://github.com/Yeachan-Heo/oh-my-codebuddy/pull/641)
