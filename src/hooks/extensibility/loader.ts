...
export const HOOK_PLUGIN_ENABLE_ENV = 'OMB_HOOK_PLUGINS';
export const HOOK_PLUGIN_TIMEOUT_ENV = 'OMB_HOOK_PLUGIN_TIMEOUT_MS';
...
export async function discoverHookPlugins(cwd: string): Promise<HookPluginDescriptor[]> {
  const dir = resolveExistingHooksDir(cwd);
