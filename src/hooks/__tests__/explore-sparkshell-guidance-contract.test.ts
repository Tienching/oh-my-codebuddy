  ...
  it('keeps execution and planning surfaces conditional on explore routing', () => {
    for (const surface of [
      ...
      expectPatterns(surface, [
        /USE_OMB_EXPLORE_CMD/i,
        /prefer `omb explore`|use `omb explore` FIRST/i,
