...
const SERVER_DISABLE_ENV: Record<McpServerName, string[]> = {
  state: ['OMB_STATE_SERVER_DISABLE_AUTO_START'],
  memory: ['OMB_MEMORY_SERVER_DISABLE_AUTO_START'],
  code_intel: ['OMB_CODE_INTEL_SERVER_DISABLE_AUTO_START'],
  trace: ['OMB_TRACE_SERVER_DISABLE_AUTO_START'],
  team: ['OMB_TEAM_SERVER_DISABLE_AUTO_START'],
  lsp: ['OMB_LSP_SERVER_DISABLE_AUTO_START'],
  shared_memory: ['OMB_SHARED_MEMORY_SERVER_DISABLE_AUTO_START'],
  wiki: ['OMB_WIKI_SERVER_DISABLE_AUTO_START'],
};

const GLOBAL_DISABLE_ENV = ['OMB_MCP_SERVER_DISABLE_AUTO_START'];
const LIFECYCLE_DEBUG_ENV = ['OMB_MCP_TRANSPORT_DEBUG'];
const PARENT_WATCHDOG_INTERVAL_ENV = 'OMB_MCP_PARENT_WATCHDOG_INTERVAL_MS';
const DUPLICATE_SIBLING_WATCHDOG_INTERVAL_ENV = 'OMB_MCP_DUPLICATE_SIBLING_WATCHDOG_INTERVAL_MS';
const DUPLICATE_SIBLING_PRE_TRAFFIC_GRACE_ENV = 'OMB_MCP_DUPLICATE_SIBLING_PRE_TRAFFIC_GRACE_MS';
const DUPLICATE_SIBLING_POST_TRAFFIC_IDLE_ENV = 'OMB_MCP_DUPLICATE_SIBLING_POST_TRAFFIC_IDLE_MS';
...
export function autoStartStdioMcpServer(
  ...
  const shutdown = async (reason: string) => {
    ...
    try {
      ...
      console.error(`[omb-${serverName}-server] shutdown failed`, error);
    }
