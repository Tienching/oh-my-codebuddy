...
const STATE_HELP = `Usage: omb state <read|write|clear|list-active|get-status> [--input <json>] [--json]\n\nExamples:\n  omb state read --input '{"mode":"ralph"}' --json\n  omb state write --input '{"mode":"ralph","active":true,"current_phase":"executing"}' --json\n  omb state clear --input '{"mode":"ralph","all_sessions":true}' --json\n  omb state list-active --json\n  omb state get-status --input '{"mode":"ralph"}' --json`;
