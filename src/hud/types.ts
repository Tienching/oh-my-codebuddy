/**
 * HUD type definitions for oh-my-codebuddy
 */
...
/** Todos state for HUD display */
export interface TodosStateForHud {
  active: boolean;
  items: TodoItem[];
  completed: number;
  total: number;
...
/** Think mode state for HUD display */
export interface ThinkingStateForHud {
  active: boolean;
  level: 'think' | 'ultrathink' | 'none';
}
...
export interface HudRenderContext {
  ...
  todos: TodosStateForHud | null;
  thinking: ThinkingStateForHud | null;
...
/** HUD configuration stored in .omb/hud-config.json */
