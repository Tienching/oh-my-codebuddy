/**
 * Pipeline Orchestrator for oh-my-codebuddy
 *
 * Sequences configurable stages (RALPLAN -> teams -> ralph verification)
 * and persists state through the ModeState system.
 *
 * Mirrors OMC #1130 pipeline design with OMB-specific adaptations:
 * - Execution backend is always teams (CodeBuddy CLI workers)
 ...
 * This is the canonical OMB pipeline matching the OMC #1130 design.
 */
