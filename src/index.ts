/**
 * oh-my-codebuddy - Multi-agent orchestration for CodeBuddy CLI
 *
 * This package provides:
 * - 30+ specialized agent prompts as CodeBuddy CLI slash commands
 * - 35+ workflow skills as SKILL.md files
 * - AGENTS.md orchestration brain
 * - MCP servers for state management, project memory, and notepad
 * - CLI tool (omb) for setup, diagnostics, and management
