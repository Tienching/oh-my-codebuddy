...
- If missing OMB marker: WARN - outdated AGENTS.md
...
**Diagnosis**:
- If `~/.codex/agents/` exists with oh-my-codebuddy-related files: WARN - legacy agents (now provided by plugin)
- If `~/.codex/commands/` exists with oh-my-codebuddy-related files: WARN - legacy commands (now provided by plugin)
- If `${CODEX_HOME:-~/.codex}/skills/` exists with OMB skills: OK - canonical current user skill root
...
- Any oh-my-codebuddy-related `.md` files in skills/
