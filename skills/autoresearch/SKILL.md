...
## Do not use when
- You want the old `omb autoresearch` command surface (hard-deprecated)
...
2. **Persist mode state** in `.omb/state/.../autoresearch-state.json` including:
   - `validation_mode`
...
2. Materialize `.omb/specs/autoresearch-{slug}/mission.md`, `sandbox.md`, and `result.json`.
